...
// Validate checks the field values on CommentsByPostRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *CommentsByPostRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CommentsByPostRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// CommentsByPostRequestMultiError, or nil if none found.
func (m *CommentsByPostRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *CommentsByPostRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return CommentsByPostRequestMultiError(errors)
	}
	return nil
}

// CommentsByPostRequestMultiError is an error wrapping multiple validation
// errors returned by CommentsByPostRequest.ValidateAll() if the designated
// constraints aren't met.
type CommentsByPostRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CommentsByPostRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CommentsByPostRequestMultiError) AllErrors() []error { return m }

// CommentsByPostRequestValidationError is the validation error returned by
// CommentsByPostRequest.Validate if the designated constraints aren't met.
type CommentsByPostRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CommentsByPostRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CommentsByPostRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CommentsByPostRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CommentsByPostRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CommentsByPostRequestValidationError) ErrorName() string {
	return "CommentsByPostRequestValidationError"
}

// Error satisfies the builtin error interface
func (e CommentsByPostRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCommentsByPostRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CommentsByPostRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CommentsByPostRequestValidationError{}

// Validate checks the field values on CommentsByPostResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *CommentsByPostResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CommentsByPostResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// CommentsByPostResponseMultiError, or nil if none found.
func (m *CommentsByPostResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *CommentsByPostResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetComments() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, CommentsByPostResponseValidationError{
			...
			if err := v.Validate(); err != nil {
				return CommentsByPostResponseValidationError{
					field:  fmt.Sprintf("Comments[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return CommentsByPostResponseMultiError(errors)
	}
	return nil
}

// CommentsByPostResponseMultiError is an error wrapping multiple validation
// errors returned by CommentsByPostResponse.ValidateAll() if the designated
// constraints aren't met.
type CommentsByPostResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CommentsByPostResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CommentsByPostResponseMultiError) AllErrors() []error { return m }

// CommentsByPostResponseValidationError is the validation error returned by
// CommentsByPostResponse.Validate if the designated constraints aren't met.
type CommentsByPostResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CommentsByPostResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CommentsByPostResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CommentsByPostResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CommentsByPostResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CommentsByPostResponseValidationError) ErrorName() string {
	return "CommentsByPostResponseValidationError"
}

// Error satisfies the builtin error interface
func (e CommentsByPostResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCommentsByPostResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CommentsByPostResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CommentsByPostResponseValidationError{}
